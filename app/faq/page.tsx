...
const faqData: FAQItem[] = [
  ...
  { category: "packages", q: { ar: "هل يمكنني تجربة حصة مجانية قبل اختيار الباقة؟", en: "Can I try a free session before subscribing?", fr: "Puis-je essayer une session gratuite?" }, a: { ar: "نعم، نقدم حصة تجريبية مجانية قبل دفع أي مبلغ لتعريفهم بالمنهج وطريقة التعليم وتقييم مستواهم.", en: "Yes, we offer a free trial session for new students to introduce our curriculum and assess their level.", fr: "Oui, nous offrons une session d'essai gratuite pour les nouveaux etudiants." } },
  ...
  { category: "general", q: { ar: "ما هي أوقات الحصص المتاحة؟", en: "What are the available working hours?", fr: "Quels sont les horaires disponibles?" }, a: { ar: "نعمل على مدار الأسبوع من الساعة 8 صباحاً حتى 11 مساءً حسب المنطقة الزمنية للطالب، مع مرونة في ترتيب المواعيد عبر WhatsApp.", en: "We operate all week from 8 AM to 11 PM Cairo time, with flexibility in scheduling based on your timezone.", fr: "De 8h a 23h heure du Caire, tous les jours, avec flexibilite." } },
  { category: "general", q: { ar: "هل يمكن إيقاف البرنامج مؤقتاً؟", en: "Can I pause my subscription?", fr: "Puis-je suspendre mon abonnement?" }, a: { ar: "نعم، يمكنك تجميد الاشتراك لمدة تصل إلى أسبوعين في حالات السفر أو المرض أو الظروف الخاصة بال��نسيق مع الإدارة.", en: "Yes, you can freeze your subscription for up to two weeks for travel, illness, or special circumstances by coordinating with administration.", fr: "Oui, suspension jusqu'a deux semaines pour voyage ou maladie." } },
  ...
  { category: "general", q: { ar: "ما مدة الباقة؟", en: "What is the package validity period?", fr: "Quelle est la validite du forfait?" }, a: { ar: "صلاحية الباقة شهر واحد من تاريخ تنسيق الباقة، ويمكن تمديدها في حالات خاصة بالتنسيق مع الإدارة.", en: "Package validity is one month from subscription date, extendable in special cases by coordinating with administration.", fr: "Validite d'un mois, prolongeable dans des cas speciaux." } },
