...
const faqData: FAQItem[] = [
  ...
  { category: "general", q: { ar: "هل يمكنني إيقاف الاشتراك مؤقتاً؟", en: "Can I pause my subscription?", fr: "Puis-je suspendre mon abonnement?" }, a: { ar: "نعم، يمكنك تجميد الاشتراك لمدة تصل إلى أسبوعين في حالات السفر أو المرض أو الظروف الخاصة بال��نسيق مع الإدارة.", en: "Yes, you can freeze your subscription for up to two weeks for travel, illness, or special circumstances by coordinating with administration.", fr: "Oui, suspension jusqu'a deux semaines pour voyage ou maladie." } },
