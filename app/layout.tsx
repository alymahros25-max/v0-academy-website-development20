...
export const metadata: Metadata = {
  ...
  description:
    "أكاديمية الحافظ المتميز لتحفيظ القرآن وتأسيس اللغة العربية أون لاين للناطقين بالعربية في الخليج وأوروبا وأمريكا وكندا، مع حصص فردية ومعلمين مؤهلين ومواعيد تناسب فروق التوقيت.",
  ...
  openGraph: {
    ...
    title: "أكاديمية الحافظ المتميز أون لاين | تحفيظ قرآن وتأسيس عربي",
    description:
      "تحفيظ القرآن وتأسيس العربية أون لاين للناطقين بالعربية في السعودية والإمارات وقطر ودول الخليج وأوروبا وأمريكا وكندا، مع تعليم فردي عن بعد.",
