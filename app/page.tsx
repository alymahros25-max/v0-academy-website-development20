...
export const metadata: Metadata = {
  title: "تعليم القرآن وتأسيس العربية أونلاين بالعربية | أكاديمية الحافظ المتميز",
  description: "دروس فردية مباشرة باللغة العربية لتعليم القرآن الكريم وتأسيس اللغة العربية للأطفال والشباب والبالغين، عبر Zoom أو Google Meet، مع حجز سهل عبر WhatsApp.",
  keywords: "تعليم القرآن وتأسيس العربية أونلاين بالعربية، دروس قرآن فردية، تعليم القرآن للأطفال والكبار، تأسيس اللغة العربية أونلاين",
  openGraph: {
    title: "تعليم القرآن وتأسيس العربية أونلاين بالعربية | أكاديمية الحافظ المتميز",
    description: "دروس فردية مباشرة باللغة العربية لتعليم القرآن الكريم وتأسيس اللغة العربية عبر Zoom أو Google Meet.",
    type: "website",
    locale: "ar_SA",
