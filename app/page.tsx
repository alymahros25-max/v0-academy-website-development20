...
export const metadata: Metadata = {
  ...
  description: "تحفيظ قرآن أون لاين وتأسيس اللغة العربية للأطفال والكبار في الخليج وأوروبا وأمريكا وكندا، بحصص فردية مباشرة باللغة العربية وحصة تجريبية مجانية.",
  ...
  openGraph: {
    title: "تحفيظ قرآن وتأسيس عربي أون لاين للناطقين بالعربية",
    description: "حصص فردية مباشرة لتحفيظ القرآن وتأسيس العربية للأطفال والكبار في الخليج وأوروبا وأمريكا وكندا، مع حصة تجريبية مجانية.",
    type: "website",
    locale: "ar_SA",
