...
const planInfoByProgram = {
  ...
  arabic: [
    ...
    ["برنامج مرن يناسب وقت الأسرة", "يمكن اختيار مدة الحصة وعدد الحصص الأسبوعية والتنسيق على موعد مناسب بتوقيت الإمارات، مع إمكانية بدء الحصة التجريبية المجانية قبل أي دفع."],
  ],
} as const
