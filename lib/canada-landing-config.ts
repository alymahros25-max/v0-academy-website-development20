...
export const canadaLandingConfig = {
  ...
  seo: {
    ...
    description: "حصص فردية أونلاين للأسر في كندا بباقات بالـالدولار الكندي، مع معلمين ومعلمات مجازين بالإسناد وخريجي الأزهر، وخصم للإخوة وحصة تجريبية مجانية.",
