...
export const defaultMetadata: Metadata = {
  ...
  description: 'أكاديمية لتحفيظ القرآن وتأسيس اللغة العربية أون لاين للناطقين بالعربية بحصص فردية مباشرة.',
  alternates: {
    canonical: `${baseUrl}/`,
  },
}
...
export function generatePageMetadata(page: 'quran' | 'arabic' | 'about' | 'teachers' | 'reviews' | 'games' | 'faq' | 'contact' | 'privacy' | 'terms' | 'checkout-success'): Metadata {
  ...
  const metadataMap: Record<string, Metadata> = {
    ...
    quran: {
      ...
      description: 'تحفيظ القرآن وحفظه ومراجعته وتعليم التلاوة والتجويد في حصص فردية مباشرة بالعربية للأطفال والكبار عبر Zoom أو Google Meet.',
    ...
    arabic: {
      ...
      description: 'تأسيس عربي أون لاين في القراءة والكتابة والإملاء والفهم والتعبير للأطفال والشباب والبالغين الناطقين بالعربية، بحصص فردية مباشرة.',
