...
export function generatePageMetadata(page: 'quran' | 'arabic' | 'about' | 'teachers' | 'reviews' | 'games' | 'faq' | 'contact' | 'privacy' | 'terms' | 'checkout-success'): Metadata {
  ...
  const metadataMap: Record<string, Metadata> = {
    ...
    quran: {
      title: 'تحفيظ القرآن أونلاين بالعربية | أكاديمية الحافظ المتميز',
      description: 'تعلّم حفظ القرآن والتلاوة والتجويد في دروس فردية مباشرة باللغة العربية للأطفال والشباب والبالغين، عبر Zoom أو Google Meet وبموعد يناسبك.',
      keywords: ['تحفيظ القرآن أونلاين بالعربية', 'دروس قرآن فردية أونلاين', 'تعليم القرآن للأطفال والكبار', 'حفظ القرآن عن بعد', 'تعليم التجويد أونلاين', 'معلم قرآن أونلاين باللغة العربية'],
    ...
    arabic: {
      title: 'تأسيس اللغة العربية أونلاين للأطفال والكبار | أكاديمية الحافظ المتميز',
      description: 'دروس فردية مباشرة باللغة العربية لتأسيس القراءة والكتابة والإملاء والفهم والتعبير للأطفال والشباب والبالغين، عبر Zoom أو Google Meet.',
      keywords: ['تأسيس اللغة العربية أونلاين بالعربية', 'دروس تأسيس اللغة العربية أونلاين', 'دروس لغة عربية فردية', 'تأسيس القراءة والكتابة بالعربية', 'تعليم القراءة للأطفال أونلاين', 'تعليم الكتابة والإملاء بالعربية', 'تقوية اللغة العربية', 'معلم لغة عربية أونلاين'],
