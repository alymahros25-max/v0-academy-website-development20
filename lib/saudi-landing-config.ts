...
export const saudiLandingConfig = {
  ...
  seo: {
    ...
    description: "حصص فردية أونلاين للأسر في السعودية لتحفيظ القرآن وتأسيس العربية، بباقات بالريال السعودي وتنسيق الموعد حسب التوقيت المحلي وحصة تجريبية مجانية.",
