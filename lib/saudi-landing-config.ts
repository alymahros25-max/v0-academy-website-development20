...
export const saudiLandingConfig = {
  ...
  seo: {
    title: "تحفيظ القرآن وتأسيس العربية أونلاين في السعودية | حصة مجانية",
    description: "حصص فردية أونلاين للأسر في السعودية بباقات بالـالريال السعودي، مع معلمين ومعلمات مجازين بالإسناد وخريجي الأزهر، وخصم للإخوة وحصة تجريبية مجانية.",
