...
export const uaeLandingConfig = {
  ...
  seo: {
    title: "تحفيظ القرآن وتأسيس العربية أونلاين في الإمارات | حصة مجانية",
    description: "حصص فردية أونلاين للأسر في الإمارات بباقات بالـالدرهم الإماراتي، مع معلمين ومعلمات مجازين بالإسناد وخريجي الأزهر، وخصم للإخوة وحصة تجريبية مجانية.",
