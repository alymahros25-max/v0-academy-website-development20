...
export const unitedKingdomLandingConfig = {
  ...
  seo: {
    ...
    description: "حصص فردية أونلاين للأسر في المملكة المتحدة بباقات بالـالجنيه الإسترليني، مع معلمين ومعلمات مجازين بالإسناد وخريجي الأزهر، وخصم للإخوة وحصة تجريبية مجانية.",
