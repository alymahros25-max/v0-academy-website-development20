    ...
    return [
      {
        ...
        headers: [
          ...
          // Do NOT remove youtube.com or youtube-nocookie.com from frame-src.
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' https://vercel.live https://*.vercel-insights.com https://www.googletagmanager.com https://*.google-analytics.com https://www.clarity.ms https://scripts.clarity.ms",
